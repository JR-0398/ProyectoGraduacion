...
public class MostrarPDF extends javax.swing.JFrame {
    ...
    public void guardar_pdf(String nombre, File ruta) {
        ControlRegis_Hist pa = new ControlRegis_Hist();
        registro_historico po = new registro_historico();
        
        po.setNombre_pdf(nombre);
        try {
            byte[] pdf = new byte[(int) ruta.length()];
            InputStream input = new FileInputStream(ruta);
            input.read(pdf);
            po.setArchivo_pdf(pdf);
        } catch (IOException ex) {
            po.setArchivo_pdf(null);
        ...
        if (row < tabla.getRowCount() && row >= 0 && column < tabla.getColumnCount() && column >= 0) {
            ...
            if (value instanceof JButton) {
                ...
                if (boton.getText().equals("Vacio")) {
                    ...
                    ControlRegis_Hist pd = new ControlRegis_Hist();
